view: registro_de_cuenta_temporal {
  sql_table_name: broxelco_rdg.registro_de_cuenta_temporal ;;
  drill_fields: [id]
  ...
  dimension: importe_ajustes_pos_no_fin_us {
    type: number
    sql: ${TABLE}.importe_ajustes_pos_no_fin_us ;;
  }
  ...
  dimension: marca_genera_liqusu {
    type: string
    sql: ${TABLE}.marca_genera_liqusu ;;
  }
